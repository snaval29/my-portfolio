    ...
    <section id="contact" className="relative w-full pt-32 pb-16 px-4 md:px-10 overflow-hidden bg-black scroll-mt-32">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                >
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        {socialLinks.map((item, i) => (
                            ...
                            >
                                <item.icon size={28} className="text-neutral-400 transition-transform group-hover:scale-110 group-hover:text-black" />
                            </a>
                        ))}
                    </div>
                </motion.div>
            ...
            >
                {/* 1. GAP-8 (32px) between separate fields */}
                <form className="flex flex-col gap-8">
                    
                    <div>
                        {/* 2. MB-2 (8px) between Label and Box, Removed 'ml-1' for perfect alignment */}
                    ...
                    <button type="button" className="mt-2 w-full rounded-xl bg-white text-black font-bold text-lg py-4 hover:bg-amber-400 transition-all hover:scale-[1.01] active:scale-[0.99] shadow-lg hover:shadow-amber-500/25">
                        Send Message
                    </button>
                </form>
            </motion.div>
