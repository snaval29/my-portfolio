...
export const Hero = () => {
  return (
    ...
    >
      ...
      {/* 2. Main Content */}
      <div className="relative z-10 flex w-full max-w-6xl flex-col items-center px-4 text-center pt-24"> 
        
        {/* Top Badge */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="mb-8 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-amber-200/80 backdrop-blur-md"
        >
        ...
        <motion.h1 
          ...
          className="max-w-5xl text-6xl font-medium tracking-tight sm:text-7xl md:text-8xl lg:text-9xl leading-[0.9]"
        >
        ...
        <motion.h2 
          ...
          className="mt-4 max-w-5xl text-5xl font-medium tracking-tight sm:text-6xl md:text-7xl lg:text-8xl leading-[0.9]"
        >
        ...
        >
          ...
          <a 
            ...
            className="group relative flex items-center gap-4 rounded-full bg-gradient-to-b from-orange-500 to-amber-700 px-8 py-4 text-lg font-medium text-white shadow-[0_0_40px_-10px_rgba(245,158,11,0.4)] transition-all hover:scale-105 hover:shadow-[0_0_60px_-10px_rgba(245,158,11,0.6)]"
          >
          ...
          <a 
            ...
            className="group flex items-center gap-4 rounded-full border border-white/10 bg-white/5 px-8 py-4 text-lg font-medium text-white backdrop-blur-md transition-all hover:bg-white/10 hover:border-amber-500/30"
          >
      ...
      >
        ...
        {/* FIX: STATIC AUDIO VIZ (No Animation) */}
